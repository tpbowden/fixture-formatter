...
const loadFixtures = async (date) => {
  ...
  const res = await fetch(
    `https://www.bbc.co.uk/wc-data/container/sport-data-scores-fixtures?selectedEndDate=${end}&selectedStartDate=${start}&todayDate=${today}&urn=urn%3Abbc%3Asportsdata%3Afootball%3Atournament%3Apremier-league&useSdApi=false`
  );
